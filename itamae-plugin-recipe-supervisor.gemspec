...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{itamae recipe for supervisor process state controlling framework}
  spec.description   = %q{itamae recipe for supervisor process state controlling framework}
  spec.homepage      = "https://github.com/maedadev/itamae-plugin-recipe-supervisor"
  spec.license       = "MIT"
  ...
  spec.add_dependency 'itamae-plugin-resource-pip', '~> 1.0'
